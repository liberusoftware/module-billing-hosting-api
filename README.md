...
> This optional API presentation package exposes approved HTTP operations for the Hosting domain module. It presents exactly one independent module, delegates all authoritative behavior to that module's public actions/queries/policies, and contains no other module's API logic.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-billing-hosting-api?sort=semver)](https://github.com/liberusoftware/module-billing-hosting-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-billing-hosting-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-billing-hosting-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-billing-hosting-api
```
...
<a href="https://github.com/liberusoftware/module-billing-hosting-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-billing-hosting-api" alt="Contributors to liberusoftware/module-billing-hosting-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-billing-hosting-api/graphs/contributors).
